...
import Lab5.Problem1.rulesets.RuleException;
import Lab5.Problem1.rulesets.RuleSet;
import Lab5.Problem1.rulesets.RuleSetFactory;
...
public class CDWindow extends JFrame {
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt){
			...
			double priceValue =  price.isEmpty() ? 0 : Double.valueOf(price);
			
			
			try {
				RuleSet rules = RuleSetFactory.getRuleSet(CDWindow.this);
				rules.applyRules(CDWindow.this);
				String output = "artist: " + artist + " title: " + title + " price: " + priceValue;
