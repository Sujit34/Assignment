...
public class Employee implements Comparable<Employee> { //implements Comparable<Employee> {
	...
	public int compareTo(Employee e) {
		//implement
		if(this.accounts.getLargest().getBalance()> e.accounts.getLargest().getBalance()) return 1;
		else if(this.accounts.getLargest().getBalance()< e.accounts.getLargest().getBalance()) return -1;
		else return 0;	 
